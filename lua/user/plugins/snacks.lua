...
return {
	...
	keys = {
		...
		},
		{
			"<leader>pkv",
			function()
				Snacks.picker.keymaps({ modes = { "v", "x", "s" } })
			end,
			desc = "Keymaps visual",
		},
		{
			"<leader>pko",
			function()
				Snacks.picker.keymaps({ modes = { "o" } })
			end,
			desc = "Keymaps operator pending",
		},
		{
			"<leader>pkc",
			function()
				Snacks.picker.keymaps({ modes = { "c" } })
			end,
			desc = "Keymaps command",
		},
		{
			"<leader>pe",
			function()
		...
		},
		{
			"<leader>sg",
			function()
				Snacks.picker.grep_word({ search = vim.fn.input("Grep > ") })
			end,
			desc = "Grep search",
		},
		{
			"<leader>sr",
			function()
				Snacks.picker.grep_word({ regex = true, search = vim.fn.input("Regex Grep > ") })
			end,
			desc = "Grep search",
		},
