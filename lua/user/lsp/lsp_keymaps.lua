...
return function(event)
	...
	vim.keymap.set("n", "<leader>lw", function()
		vim.lsp.buf.workspace_symbol("", { loclist = false })
	end, desc("Workspace Symbols"))
	vim.keymap.set("n", "<leader>lq", function()
		vim.lsp.buf.workspace_symbol(nil, { loclist = false })
	end, desc("Workspace Symbols query"))
	...
	vim.keymap.set("n", "<leader>cld", function()
		vim.lsp.codelens.display(vim.lsp.codelens.get(buffer), buffer, client_id)
	end, desc("Codelens display"))
	vim.keymap.set("n", "<leader>clc", function()
		vim.lsp.codelens.clear(client_id, buffer)
	end, desc("Codelens clear"))
