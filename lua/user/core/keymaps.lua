...
vim.keymap.set('n', '<leader>msv', '<C-w>t<C-w>H', desc('Make horizontal split vertical'))
vim.keymap.set('n', '<leader>msh', '<C-w>t<C-w>K', desc('Make vertical split horizontal'))
